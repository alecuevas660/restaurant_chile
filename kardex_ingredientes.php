    ...
    <div class="row">
        <div class="col-md-12">
           <div class="form-group has-feedback">
               ...
               <input style="color:#000;font-weight:bold;" type="text" class="form-control" name="search_ingrediente_sucursal" id="search_ingrediente_sucursal" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Descripción del Ingrediente para tu Búsqueda" autocomplete="off" required="" aria-required="true"/>  
              <i class="fa fa-search form-control-feedback"></i> 
                    ...
                    <div class="text-right">
                        <button type="button" id="BotonBusqueda" onClick="BuscaKardexIngredientes()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
