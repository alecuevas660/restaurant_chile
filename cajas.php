...
<?php } ?>
        ...
        <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Cajas de Ventas</h5>
                    </div>
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                <li class="breadcrumb-item">Cajas</li>
                                <li class="breadcrumb-item active" aria-current="page">Cajas de Ventas</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="cajasxsucursal" id="cajasxsucursal">
            ...
            <div class="text-right">
                <button type="button" id="BotonBusqueda" onClick="BuscaCajasxSucursal()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
            </div>
