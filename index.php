<?php
// ===== index.php (versión mínima, prod-safe) =====

// (Opcional) evitar cachear login
header('Cache-Control: no-store, no-cache, must-revalidate, max-age=0');
header('Pragma: no-cache');

// Proxy HTTPS (Railway) → cookie Secure
if (($_SERVER['HTTP_X_FORWARDED_PROTO'] ?? '') === 'https') {
    $_SERVER['HTTPS'] = 'on';
    ini_set('session.cookie_secure', '1');
}

// Sesiones en contenedor
  ...
  <div class="auth-wrapper d-flex no-block justify-content-center align-items-center"
    ...
    <div class="auth-box">
      ...
      <div id="loginform">
        <div class="logo">
          <span class="db">
            <?php if (file_exists("fotos/logo_login.png")){
...
<!-- JS (NO volver a cargar jQuery aquí) -->
