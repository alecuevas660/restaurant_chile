        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    ...
                    <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Detalles de Créditos</h5>
                    </div>
...
<div class="row">
    ...
    <form class="form form-material" method="post" action="#" name="detallescreditosxclientes" id="detallescreditosxclientes">
    ...
    <button type="button" id="BotonBusqueda" onClick="BuscarDetallesCreditosxClientes()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestradetallescreditosxclientes"></div>
