   ...
   <!-- ============================================================== -->
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-boxed-layout="full" data-boxed-layout="boxed" data-header-position="fixed" data-sidebar-position="fixed" class="mini-sidebar">              
        ...
        <div class="page-wrapper">
            ...
            <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Combos Vendidos</h5>
                    </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-warning">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Combos Vendidos</h4>
            </div>
            
    <form class="form form-material" method="post" action="#" name="combosvendidos" id="combosvendidos">
            ...
            <div class="form-group has-feedback">
                ...
                <i class="fa fa-calendar form-control-feedback"></i>
                    ...
                    <div class="text-right">
                        <button type="button" id="BotonBusqueda" onClick="BuscaCombosVendidos()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestracombosvendidos"></div>
