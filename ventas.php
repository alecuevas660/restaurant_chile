...
<body onLoad="muestraReloj(); <?php if($_SESSION['acceso'] != "administradorG"){ ?>CargarVentas()<?php } ?>" class="fix-header">
...
<div class="row">
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="ventasxsucursal" id="ventasxsucursal">
            ...
            <div class="text-right">
                <button type="button" id="BotonBusqueda" onClick="BuscaVentasxSucursal()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
            </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="form-body">
                ...
                <form class="form form-material" method="post" action="#" name="busquedaventas" id="busquedaventas">
                ...
                <div class="text-right">
                    <button type="button" id="BotonBusqueda" onClick="BuscarVentas()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                </div>
...
<?php } ?>
    ...
    function CargarVentas(){
        ...
        setTimeout(function() {
        $('#muestra_detalles').load("consultas?CargaVentas=si&tipobusqueda=1&search_criterio=&desde=&hasta=");
        }, 200);
    }    
    </script>
    <?php } ?>
