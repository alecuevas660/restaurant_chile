...
<body onLoad="muestraReloj(); <?php if($_SESSION['acceso'] != "administradorG"){ ?>CargarPedidos()<?php } ?>" class="fix-header">
   ...
   <!-- ============================================================== -->
    ...
    <!--############################## MODAL PARA ACTUALIZAR TOMA DE PEDIDO ######################################-->
    <!-- sample modal content -->
    <div id="myModalTomaPedido" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-warning">
                    <h4 class="modal-title text-white" id="myModalLabel"><i class="fa fa-tasks"></i> Actualizar Toma de Pedido</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button>
                </div>
                
                <form class="form form-material" method="post" action="#" name="updatetomapedido" id="updatetomapedido">

                <div class="modal-body">

                <div id="muestratomapedidomodal"></div>
    ...
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="pedidosxsucursal" id="pedidosxsucursal">
            ...
            <div class="text-right">
                <button type="button" id="BotonBusqueda" onClick="BuscaPedidosxSucursal()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
            </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="form-body">
                ...
                <form class="form form-material" method="post" action="#" name="busquedapedidos" id="busquedapedidos">
                ...
                <div class="text-right">
                    <button type="button" id="BotonBusqueda" onClick="BuscarPedidos()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                </div>
...
<?php } ?>
    ...
    function CargarPedidos(){
        ...
        setTimeout(function() {
        $('#muestra_detalles').load("consultas?CargaPedidos=si&tipobusqueda=1&search_criterio=&desde=&hasta=");
        }, 200);
    }    
    </script>
    <?php } ?>
