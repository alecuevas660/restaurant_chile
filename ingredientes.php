...
$accesos = ['administradorG', 'administradorS', 'secretaria', 'cajero', 'cocinero'];
...
elseif(isset($_POST["proceso"]) and $_POST["proceso"]=="savestock")
{
    $reg = $tra->SumarStockIngrediente();
    exit;
} 
?>
<!DOCTYPE html>
...
<body onLoad="muestraReloj()" class="fix-header">
   ...
   <!-- ============================================================== -->
    ...
    <!-- ============================================================== -->
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-boxed-layout="full" data-sidebar-position="fixed" class="mini-sidebar"> 

<!--############################## MODAL PARA VER DETALLES DE INGREDIENTE ######################################-->
...
<!--############################## MODAL PARA CARGA MASIVA DE INGREDIENTE ######################################-->
<!-- sample modal content -->
<div id="myModalCargaMasiva" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="btn-cargar" id="btn-cargar" class="btn btn-primary"><span class="fa fa-cloud-upload"></span> Cargar</button>
...
<div id="myModalStock" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form class="form form-material" method="post" action="#" name="savestockingrediente" id="savestockingrediente">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control" name="codingrediente" id="codingrediente" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Código de Ingrediente" autocomplete="off" disabled="" required="" aria-required="true"/> 
            ...
            <div class="col-md-6">
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control" name="nomingrediente" id="nomingrediente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Nombre de Ingrediente" autocomplete="off" disabled="" required="" aria-required="true"/> 
        ...
        <div class="row">
            ...
            <div class="modal-footer">
                ...
                document.getElementById('codingrediente').value = '',
                document.getElementById('nomingrediente').value = '',
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <form class="form form-material" method="post" action="#" name="ingredientesxsucursal" id="ingredientesxsucursal">
            ...
            <div class="text-right">
                <button type="button" id="BotonBusqueda" onClick="BuscaIngredientesxSucursal()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
            </div>
...
<div id="muestraingredientes"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-left" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(164px, 35px, 0px);">
                                ...
                                <a class="dropdown-item" href="reportepdf?tipo=<?php echo encrypt("INGREDIENTES") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="bottom" title="Exportar Pdf"><span class="fa fa-file-pdf-o text-dark"></span> Listado General</a>

                                <a class="dropdown-item" href="reportepdf?tipo=<?php echo encrypt("INGREDIENTESMINIMO") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="bottom" title="Exportar Pdf"><span class="fa fa-file-pdf-o text-dark"></span> Stock Minimo</a>

                                <a class="dropdown-item" href="reportepdf?tipo=<?php echo encrypt("INGREDIENTESMAXIMO") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="bottom" title="Exportar Pdf"><span class="fa fa-file-pdf-o text-dark"></span> Stock Máximo</a>
