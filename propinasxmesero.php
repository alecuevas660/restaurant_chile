   ...
   <!-- ============================================================== -->
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-boxed-layout="full" data-boxed-layout="boxed" data-header-position="fixed" data-sidebar-position="fixed" class="mini-sidebar">              
        ...
        <div class="page-wrapper">
            ...
            <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Propinas por Fechas</h5>
                    </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-warning">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Propinas por Fechas</h4>
            </div>
            
    <form class="form form-material" method="post" action="#" name="propinasxfechas" id="propinasxfechas">
    ...
    <div class="row">
        <div class="col-md-12"> 
            <div class="form-group has-feedback"> 
                ...
                <select style="color:#000;font-weight:bold;" name="codsucursal" id="codsucursal" class="form-control" onChange="CargaUsuariosMeseros(this.form.codsucursal.value);" required="" aria-required="true">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group has-feedback">
                <label class="control-label">Seleccione Mesero(a): <span class="symbol required"></span></label>
                <i class="fa fa-bars form-control-feedback"></i>
                <?php if($_SESSION['acceso'] == "administradorG") { ?>
                ...
                <?php
                $usuario = new Login();
                $usuario = $usuario->ListarUsuariosMeseros();
                if($usuario==""){ 
                    echo "";
                } else {
            ...
            <input type="text" class="form-control" name="hasta" id="hasta" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Fecha Hasta" autocomplete="off" required="" aria-required="true"/>  
                <i class="fa fa-calendar form-control-feedback"></i>
                    ...
                    <div class="text-right">
                        <button type="button" id="BotonBusqueda" onClick="BuscaPropinasxFechas()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestrapropinasxfechas"></div>
