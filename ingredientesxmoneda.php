   ...
   <!-- ============================================================== -->
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-boxed-layout="full" data-header-position="fixed" data-sidebar-position="fixed" class="mini-sidebar">              
        ...
        <div class="page-wrapper">
            ...
            <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Ingredientes por Moneda</h5>
                    </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-warning">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Ingredientes por Moneda</h4>
            </div>
            
    <form class="form form-material" method="post" action="#" name="ingredientesxmoneda" id="ingredientesxmoneda">
            ...
            <div class="form-group has-feedback"> 
                ...
                <?php } } ?>
                    ...
                    <div class="text-right">
                        <button type="button" id="BotonBusqueda" onClick="BuscaIngredientesxMoneda()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestraingredientesxmoneda"></div>
