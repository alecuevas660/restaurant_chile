    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group has-feedback">
                ...
                <input type="hidden" name="preciocompra" id="preciocompra" value="0"/>
                <input type="hidden" name="precioventa" id="precioventa" value="0"/>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group has-feedback">
                ...
                <br /><abbr title="Impuesto de Producto"><?php echo $reg[0]['ivaproducto'] != '0' ? number_format($valor, 0, '.', '.')."%" : "(E)"; ?></abbr>
            </div>
        </div>
...
?>
    <tr class="warning-element" style="border-left: 2px solid #c86262 !important; background: #ece8e9;">
        <td><?php echo $a++; ?></td>
    ...
    <div class="row">
        ...
        <div class="col-md-3">  
            <div class="form-group has-feedback"> 
                ...
                <input style="color:#000;font-weight:bold;" type="text" class="form-control agregaingrediente" name="cantidad" id="cantidad" onKeyUp="this.value=this.value.toUpperCase();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" placeholder="Ingrese Cantidad de Porción" title="Ingrese Cantidad de Porción" autocomplete="off" value="0.5"/>  
