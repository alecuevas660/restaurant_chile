        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group has-feedback">
                    ...
                    <input type="hidden" name="formulario" id="formulario" value="delivery"/>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="row">
            ...
            <div class="col-md-3"> 
                ...
                <input style="color:#000;font-weight:bold;" class="form-control" type="text" name="montodelivery" id="montodelivery" onKeyUp="DevolucionDelivery();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" autocomplete="off" placeholder="Ingrese Costo Delivery" value="0" disabled="" required="" aria-required="true"> 
        ...
        <div class="row">
          <div class="col-md-12"> 
            <div class="form-group has-feedback"> 
              ...
              <input style="color:#000;font-weight:bold;" class="form-control" type="text" name="montopagado" id="montopagado" onKeyUp="DevolucionDelivery();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" autocomplete="off" placeholder="Monto de Pago Nº 1" value="" required="" aria-required="true"> 
              <i class="fa fa-dollar form-control-feedback"></i>
            </div> 
          </div>
        </div>
...
<div class="row">
    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group has-feedback2">
                    <label class="control-label">Dirección Delivery: </label>
                    <textarea class="form-control" type="text" name="direccion_delivery" id="direccion_delivery" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Dirección Delivery" rows="2" required="" aria-required="true"></textarea>
...
<!-- End Row -->
    ...
    setTimeout(function() {
        $('#notificaciones').load("notificaciones?CargaNotificacion=si&tipo="+'<?php echo encrypt('2'); ?>');
    }, 5000);
