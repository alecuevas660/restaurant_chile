   ...
   <!-- ============================================================== -->
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-boxed-layout="full" data-boxed-layout="boxed" data-header-position="fixed" data-sidebar-position="fixed" class="mini-sidebar">              
        ...
        <div class="page-wrapper">
            ...
            <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Kardex Valorizado por Fechas</h5>
                    </div>
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                <li class="breadcrumb-item">Mantenimiento</li>
                                <li class="breadcrumb-item active" aria-current="page">Valorizado por Fechas</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<div class="row">
    ...
    <form class="form form-material" method="post" action="#" name="valorizadoingredientesxfechas" id="valorizadoingredientesxfechas">
            ...
            <div class="form-group has-feedback">
                ...
                <i class="fa fa-calendar form-control-feedback"></i>
                    ...
                    <div class="text-right">
                        <button type="button" id="BotonBusqueda" onClick="BuscaValorizadoIngredientesxFechas()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestrakardexvalorizadofechas"></div>
