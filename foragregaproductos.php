    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group has-feedback">
                ...
                <br /><abbr title="Impuesto de Combo"><?php echo $reg[0]['ivacombo'] != '0' ? number_format($valor, 0, '.', '.')."%" : "(E)"; ?></abbr>
            </div>
        </div>
...
<td><?php echo number_format($busq[$i]["cantidad"]*$busq[$i]["preciocompra"], 0, '.', '.'); ?></td>
<td><?php echo number_format($busq[$i]["cantidad"]*$busq[$i]["precioventa"], 0, '.', '.'); ?></td>
