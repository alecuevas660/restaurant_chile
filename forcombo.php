                  ...
                  <div class="text-center"><div class="fileinput fileinput-new" data-provides="fileinput">
                      <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 200px;">
                        ...
                        if (isset($reg[0]['codcombo'])) {
                            ...
                            echo "<img src='fotos/combos/".$reg[0]["codsucursal"]."/".$reg[0]['codcombo'].".jpg?".date('h:i:s')."' class='rounded-circle' width='200' height='200'>";
                            } else if (file_exists("fotos/combos/".$reg[0]["codsucursal"]."/".$reg[0]["codcombo"].".jpeg")){
                            echo "<img src='fotos/combos/".$reg[0]["codsucursal"]."/".$reg[0]["codcombo"].".jpeg?".date('h:i:s')."' class='rounded-circle' width='200' height='200'>";
                            } else if (file_exists("fotos/combos/".$reg[0]["codsucursal"]."/".$reg[0]["codcombo"].".png")){
                            echo "<img src='fotos/combos/".$reg[0]["codsucursal"]."/".$reg[0]["codcombo"].".png?".date('h:i:s')."' class='rounded-circle' width='200' height='200'>";
                            } else {
            ...
            <div class="row">
                <div class="col-md-12"> 
                    <div class="form-group has-feedback"> 
                        ...
                        <select style="color:#000;font-weight:bold;" name="codsucursal" id="codsucursal" onChange="CargaMedidasxSucursal(this.form.codsucursal.value); CargaImpuestosCombosxSucursal(this.form.codsucursal.value); CargaProveedoresxSucursal(this.form.codsucursal.value);" class="form-control" required= "" aria-required="true">
                        ...
                        <?php } else { ?>
                        <select style="color:#000;font-weight:bold;" name="codsucursal" id="codsucursal" onChange="CargaMedidasxSucursal(this.form.codsucursal.value); CargaImpuestosIngredientesxSucursal(this.form.codsucursal.value); CargaProveedoresxSucursal(this.form.codsucursal.value);" class="form-control" required="" aria-required="true">
                        <option value=""> -- SELECCIONE -- </option>
                        <?php
                        $sucursal = new Login();
                        $sucursal = $sucursal->ListarSucursales();
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control" name="desccombo" id="desccombo" onKeyUp="this.value=this.value.toUpperCase();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" placeholder="Ingrese Descuento de Combo" autocomplete="off" <?php if (isset($reg[0]['desccombo'])) { ?> value="<?php echo number_format($reg[0]['desccombo'], 0, '.', ''); ?>" <?php } else { ?> value="0.00" <?php } ?> required="" aria-required="true"/>  
                        <i class="fa fa-tint form-control-feedback"></i>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group has-feedback">
                    ...
                    <input style="color:#000;font-weight:bold;" type="text" class="form-control agregaproducto" name="search_producto_combos" id="search_producto_sucursal" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Realice la Búsqueda de Producto" autocomplete="off"/>
            ...
            <div class="col-md-3">  
                <div class="form-group has-feedback"> 
                    ...
                    <input style="color:#000;font-weight:bold;" type="text" class="form-control agregaproducto" name="cantidad" id="cantidad" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Cantidad de Producto" title="Ingrese Cantidad de Producto" autocomplete="off" value="1" />  
                    <i class="fa fa-pencil form-control-feedback"></i>                                           
                </div>
            </div>
            ...
            <div class="col-md-3">  
                <div class="form-group has-feedback"> 
                    ...
                    <input style="color:#000;font-weight:bold;" type="text" class="form-control" name="categoria" id="categoria" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Categoria de Producto" autocomplete="off" readonly=""/>  
                    <i class="fa fa-pencil form-control-feedback"></i>                                           
                </div>
            </div>  
        </div>
...
?>
    ...
    <span class="input-group-btn input-group-prepend"><button class="btn btn-classic bootstrap-touchspin-down input-button" style="cursor:pointer;border-radius:5px 0px 0px 5px;background-color:#ffb22b;" type="button" onClick="PresionarDetalleProducto('a',<?php echo $count; ?>)"><span class='fa fa-minus'></span></button></span>
    ...
    <span class="input-group-btn input-group-append"><button class="btn btn-classic bootstrap-touchspin-up" type="button" style="cursor:pointer;border-radius:0px 5px 5px 0px;background-color:#ffb22b;" onClick="PresionarDetalleProducto('b',<?php echo $count; ?>)"><span class='fa fa-plus'></span></button></span>
    </div>
    </td>
    <td>
    ...
    <input type="hidden" name="existencia2[]" id="existencia2_<?php echo $count; ?>" value="<?php echo $busq[$i]["existencia"]; ?>">
    ...
    <td><label id="txtmontocompra_<?php echo $count; ?>"><?php echo number_format($busq[$i]["cantidad"]*$busq[$i]["preciocompra"], 0, '.', ','); ?></label></td>
    <td><label id="txtmontoventa_<?php echo $count; ?>"><?php echo number_format($busq[$i]["cantidad"]*$busq[$i]["precioventa"], 0, '.', ','); ?></label></td>
        </tr><?php } } ?>
        </tbody>
    </table></div><br>
    ...
    document.getElementById('desccombo').value = ''"><span class="fa fa-trash-o"></span> Limpiar</button>
    <?php } ?>  
        </div>
