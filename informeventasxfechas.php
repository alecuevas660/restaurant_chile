...
<body onLoad="muestraReloj()" class="fix-header">
   ...
   <!-- ============================================================== -->
    ...
    <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Informe por Fechas</h5>
                    </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-warning">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Informe por Fechas</h4>
            </div>
            
    <form class="form form-material" method="post" action="#" name="informesventasxfechas" id="informesventasxfechas">
    ...
    <div class="row">
        ...
        <button type="button" id="BotonBusqueda" onClick="BuscarInformesVentasxFechas()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestrainformesventasxfechas"></div>
