...
$(document).ready(function() {
    ...
    function AgregaProductos () {
        ...
        Carrito.Producto = $('input#search_producto_sucursal').val();
...
function addItem(id, codigo, cantidad, producto, categoria, precio, precio2, opCantidad) {
    var Carrito = new Object();
    Carrito.Id = id;
