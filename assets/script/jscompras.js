...
$(document).ready(function() {
    ...
    function AgregaCompras () {
        ...
        if (code == "") {
            $("#search_compra").focus();
            $("#search_compra").css('border-color', '#f0ad4e');
        ...
        } else if(tipo == "PRODUCTO" && prec2=="" || tipo == "PRODUCTO" && prec2=="0"){
            $("#precioventa").focus();
        ...
        $.post('carritocompra.php', {
            ...
            function(data, textStatus) {
                ...
                "<td><h6><label>" + Separador(Math.round(item.precio)) + "</label></h6></td>" +
                "<td><h6><label>" + Separador(Math.round(ValorTotal.toFixed(2))) + "</label></h6></td>" +
                "<td><h6><label>" + Separador(Math.round(DetalleDescuento.toFixed(2))) + "<sup>" + Math.round(item.descproductofact) + "%</sup></label></h6></td>" +
...
function addItem(codigo, cantidad, producto, codcategoria, categorias, precio, precio2, descproductofact, descproducto, ivaproducto, precioconiva, lote, fechaelaboracion, fechaexpiracion, tipo, opCantidad) {
    var Carrito = new Object();
