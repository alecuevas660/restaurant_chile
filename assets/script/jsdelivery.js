...
function AsignaDescuento(codigo,tipo,cantidad,precio2,descproducto,observacion,salsa)
{
  ...
  $("#agregadescuento #agrega_detalle_descuento").load("detalles_delivery?BuscaDetallesProductoxDescuento=si&d_codigo="+codigo+"&d_tipo="+tipo+"&d_cantidad="+cantidad+"&d_precio="+precio2+"&d_descproducto="+descproducto+"&d_observacion="+observacion+"&d_salsa="+salsa);
}
// ####################### FUNCION PARA ASIGNAR DESCUENTO A DETALLES #######################
...
function AsignaObservacion(codigo,tipo,cantidad,precio2,descproducto,observacion,salsa)
{
  ...
  $("#agregaobservaciones #agrega_detalle_observacion").load("detalles_delivery?BuscaDetallesProductoxObservacion=si&d_codigo="+codigo+"&d_tipo="+tipo+"&d_cantidad="+cantidad+"&d_precio="+precio2+"&d_descproducto="+descproducto+"&d_observacion="+observacion+"&d_salsa="+salsa);
}
// ####################### FUNCION PARA ASIGNAR OBSERVACION A DETALLES #######################
...
function AsignaSalsa(codigo,tipo,cantidad,precio2,descproducto,observacion,salsa)
{
  ...
  $("#agregasalsas #agrega_detalle_salsa").load("detalles_delivery?BuscaDetallesProductoxSalsa=si&d_codigo="+codigo+"&d_tipo="+tipo+"&d_cantidad="+cantidad+"&d_precio="+precio2+"&d_descproducto="+descproducto+"&d_observacion="+observacion+"&d_salsa="+salsa);
}
// ####################### FUNCION PARA ASIGNAR SALSAS A DETALLES #######################
...
$(document).ready(function() {
    ...
    $('#savedelivery').keypress(function(e){
            ...
            if (code == "") {
                ...
                "<tr class='warning-element' style='border-left: 2px solid #ffb22b !important; background: #fefde3;'>" +
                    ...
                    $(nuevaFila).appendTo("#carrito tbody");
                        ...
                        $("#txtAgregado").val(Math.round(TotalFactura.toFixed(2)));
...
$(document).ready(function(){
    $('#descuento2').keyup(function(){
        ...
        $("#lbldescuento2").text(Math.round(Separador(TotalDescuentoGeneral.toFixed(2))));
        $("#lbltotal2").text(Math.round(Separador(TotalFactura.toFixed(2))));
        $("#txtDescuento2").val(Math.round(TotalDescuentoGeneral.toFixed(2)));
        $("#txtTotal2").val(Math.round(TotalFactura.toFixed(2)));
...
var dataString = 'BuscaCondicionesPagosDelivery=si&tipopago='+tipopago+"&txtTotal="+montototal;
...
function CargaDetallesSalsas(){        
    ...
    //$("#muestradetallesalsas").load("detalles_delivery.php?CargaDetalleSalsasAgregadas=si&nomsalsa="+categorias);
}
