            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        ...
                        <input type="hidden" name="formulario" id="formulario" value="creditosxfechas"/>
...
<div class="row">
    ...
    <div class="row">
        ...
        <button type="button" id="BotonBusqueda" onClick="BuscarCreditosxFechas()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
