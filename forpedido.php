            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        ...
                        <input type="hidden" name="formulario" id="formulario" value="forpedido"/>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        ...
                        <input style="color:#000;font-weight:bold;" type="text" class="form-control" name="limitecredito" id="limitecredito" onKeyUp="this.value=this.value.toUpperCase();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" placeholder="Ingrese Limite de Crédito" autocomplete="off" value="0" required="" aria-required="true"/>  
    ...
    <div class="row">
        <div class="col-md-6">
          <div class="form-group has-feedback">
            ...
            <input type="hidden" name="nrodocumento" id="nrodocumento" value="<?php echo $reg[0]['codcliente'] == '' ? "0" : $reg[0]['dnicliente']; ?>">
        ...
        <div class="col-md-6"> 
            <div class="form-group has-feedback"> 
                ...
                <i class="fa fa-bars form-control-feedback"></i>
                <select style="color:#000;font-weight:bold;" name="repartidor" id="repartidor" class="form-control" required="" aria-required="true">
                <option value="0"> -- SELECCIONE -- </option>
                <?php
                $usuario = new Login();
                $usuario = $usuario->ListarUsuariosRepartidores();
                if($usuario==""){ 
                            echo "";
                } else {
...
<div id="myModalPago" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h4 class="modal-title text-white" id="myModalLabel"><i class="fa fa-tasks"></i> Actualizar Pedido</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" name="bpsii" id="bpsii1" value="1" <?php if (isset($reg[0]['bpsii']) && $reg[0]['bpsii'] == 1) { ?> checked="checked" <?php } else { ?> checked="checked" <?php } ?>>
                        <label class="custom-control-label" for="bpsii1">SI</label>
                    </div>

                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" name="bpsii" id="bpsii2" value="2" <?php if (isset($reg[0]['bpsii'])) { ?> <?php if($reg[0]['bpsii'] == 2) { ?> checked="checked" <?php } } else { ?> checked="checked" <?php } ?>>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="custom-control custom-radio">
                    <input type="radio" class="custom-control-input" id="statuspedido0" name="statuspedido" value="0" <?php if (isset($reg[0]['statuspedido']) && $reg[0]['statuspedido'] == 0) { ?> checked="checked" <?php } else { ?> checked="checked" <?php } ?>>
                    <label class="custom-control-label" for="statuspedido0">ENTREGADO</label>
                    </div>

                    <div class="custom-control custom-radio">
                    <input type="radio" class="custom-control-input" id="statuspedido1" name="statuspedido" value="1" <?php if (isset($reg[0]['statuspedido']) && $reg[0]['statuspedido'] == 1) { ?> checked="checked" <?php } ?>>
                    <label class="custom-control-label" for="statuspedido1">PENDIENTE</label>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12"> 
                <div class="form-group has-feedback"> 
                    ...
                    <i class="fa fa-bars form-control-feedback"></i>
                    <input type="hidden" name="montopropina" id="montopropina" value="0">
        ...
        <div class="row">
            <div class="col-md-12"> 
                    ...
                    <input type="hidden" name="montodevuelto" id="montodevuelto" value="0">
        ...
        <div class="row">
            <div class="col-md-4"> 
                <div class="form-group has-feedback"> 
                    ...
                    <input type="hidden" name="montopagado2" id="montopagado2" value="0">
                    <input type="hidden" name="montodevuelto" id="montodevuelto" value="0">
                    <input type="hidden" name="montopropina" id="montopropina" value="0">
...
?>
    ...
    <input type="hidden" name="precioconiva[]" id="precioconiva_<?php echo $count; ?>" value="<?php echo $detalle[$i]['ivaproducto'] == '0' ? "0" : number_format($detalle[$i]["precioventa"], 2, '.', ''); ?>"><?php echo number_format($detalle[$i]['precioventa'], 0, '.', ','); ?></strong></td>
    ...
    <td><input type="hidden" name="ivaproducto[]" id="ivaproducto_<?php echo $count; ?>" value="<?php echo $detalle[$i]["ivaproducto"]; ?>"><label><?php echo $detalle[$i]['ivaproducto'] != '0' ? number_format($detalle[$i]['ivaproducto'], 0, '.', '')."%" : "(E)"; ?></label></td>

    <td><input type="hidden" class="subtotalivasi" name="subtotalivasi[]" id="subtotalivasi_<?php echo $count; ?>" value="<?php echo $detalle[$i]['ivaproducto'] != '0' ? number_format($detalle[$i]['valorneto'], 0, '.', '') : "0"; ?>">

    <input type="hidden" class="subtotalivano" name="subtotalivano[]" id="subtotalivano_<?php echo $count; ?>" value="<?php echo $detalle[$i]['ivaproducto'] == '0' ? number_format($detalle[$i]['valorneto'], 0, '.', '') : "0"; ?>">
...
<a href="pedidos"><button class="btn btn-dark" type="button"><span class="fa fa-trash-o"></span> Cancelar</button></a>
              </div>
          </div>
       </div>
     </form>
...
<div id="myModalPago" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button>
        ...
        <div class="row">
            <div class="col-md-4">
            	<h4 class="mb-0 font-light">Total a Pagar</h4>
            	<h4 class="mb-0 font-medium"><?php echo $simbolo; ?><label id="TextImporte" name="TextImporte"></label></h4>
            </div>

            <div class="col-md-4">
            	<h4 class="mb-0 font-light">Total Recibido</h4>
            	<h4 class="mb-0 font-medium"><?php echo $simbolo; ?><label id="TextPagado" name="TextPagado"></label></h4>
            </div>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                    <label class="control-label">BPSII: <span class="symbol required"></span></label><br>
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" name="bpsii" id="1" value="1">
                        <label class="custom-control-label" for="1">SI</label>
                    </div>

                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" name="bpsii" id="2" value="2" checked="checked">
            ...
            <div class="col-md-3"> 
                <div class="form-group has-feedback"> 
                <label class="control-label">Costo Delivery: <span class="symbol required"></span></label>
                <input style="color:#000;font-weight:bold;" class="form-control" type="text" name="montodelivery" id="montodelivery" onKeyUp="DevolucionPedido();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" autocomplete="off" placeholder="Ingrese Costo Delivery" value="0" required="" aria-required="true"> 
                <i class="fa fa-dollar form-control-feedback"></i>
                </div> 
            </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12"> 
            <div class="form-group has-feedback"> 
              <label class="control-label">Monto de Pago Nº 1: <span class="symbol required"></span></label>
              <input type="hidden" name="montodevuelto" id="montodevuelto" value="0">
              <input style="color:#000;font-weight:bold;" class="form-control" type="text" name="montopagado" id="montopagado" onKeyUp="DevolucionPedido();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" autocomplete="off" placeholder="Monto de Pago Nº 1" value="" required="" aria-required="true">
              <i class="fa fa-dollar form-control-feedback"></i>
            </div> 
          </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <label class="control-label">Estado de Pedido: <span class="symbol required"></span></label>
                <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" id="statuspedido0" name="statuspedido" value="0" checked="checked">
                <label class="custom-control-label" for="statuspedido0">ENTREGADO</label>
                </div>

                <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" id="statuspedido1" name="statuspedido" value="1">
                <label class="custom-control-label" for="statuspedido1">PENDIENTE</label>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group has-feedback">
                <label class="control-label">Fecha de Entrega: <span class="symbol required"></span></label>
                <input style="color:#000;font-weight:bold;" type="text" class="form-control expira" name="fechaentrega" id="fechaentrega" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Fecha de Entrega" autocomplete="off" value="<?php echo date("d-m-Y"); ?>" required="" aria-required="true"/>
                <i class="fa fa-calendar form-control-feedback"></i>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group has-feedback">
                <label class="control-label">Hora de Entrega: <span class="symbol required"></span></label>
                <input style="color:#000;font-weight:bold;" type="text" class="form-control" name="horaentrega" id="horaentrega" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Hora de Entrega" autocomplete="off" value="<?php echo date("H:i"); ?>" required="" aria-required="true"/>
                <i class="fa fa-calendar form-control-feedback"></i>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-md-6">
                <span id="submit_guardar"><button type="submit" name="btn-cerrar" id="btn-cerrar" class="btn btn-warning btn-lg btn-block waves-effect waves-light"><span class="fa fa-print"></span> Facturar e Imprimir</button></span>
            </div>
            <div class="col-md-6">
                <button type="reset" class="btn btn-dark btn-lg btn-block waves-effect waves-light" class="close" data-dismiss="modal" aria-hidden="true"><span class="fa fa-trash-o"></span> Cancelar</button>
            </div>
...
<div class="row">
    ...
    <div class="row">
        ...
        <div class='alert alert-danger'>
            <center><span class='fa fa-info-circle'></span> POR FAVOR DEBE DE REALIZAR EL ARQUEO DE CAJA ASIGNADA PARA PROCESAR VENTAS <a href="arqueos" class="text-dark alert-link">REALIZAR ARQUEO</a></div></center>
    ...
    <div id="favoritos" style="display:none !important;"></div>
        ...
        <div class="table-responsive">
            <table id="carritototal" width="100%">
                <tr>
                   <td class="text-left"><label>TOTAL DE ITEMS:</label></td>
                   <td class="text-right"><label id="lblitems" name="lblitems">0.00</label></td>
                </tr>
                <tr>
                   <td class="text-left"><label>DESCONTADO:</label></td>
                   <td class="text-right"><?php echo $simbolo; ?><label id="lbldescontado" name="lbldescontado">0</label></td>
                </tr>
                <tr>
                   <td class="text-left"><label>SUBTOTAL:</label></td>
                   <td class="text-right"><?php echo $simbolo; ?><label id="labelsubtotal" name="labelsubtotal">0</label></td>
                </tr>
                <tr>
                   <td class="text-left"><label><?php echo $impuesto; ?> (<?php echo number_format($valor, 0, '.', ''); ?>%):</label></td>
                   <td class="text-right"><?php echo $simbolo; ?><label id="lbliva" name="lbliva">0</label></td>
                </tr>
                <tr>
                    <td class="text-left"><label>DESC <input class="number" type="text" name="descuento" id="descuento" onKeyPress="EvaluateText('%f', this);" style="border-radius:4px;height:25px;width:50px;" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" value="<?php echo number_format($_SESSION['descsucursal'], 0, '.', ''); ?>"> %:</label></td>
                    <td class="text-right"><?php echo $simbolo; ?><label id="lbldescuento" name="lbldescuento">0</label></td>
                </tr>
                <tr>
                    <td class="text-left"><label>TOTAL A CONFIRMAR:</label></td>
                    <td class="text-right"><?php echo $simbolo; ?><label id="lbltotal" name="lbltotal">0</label></td>
                    <input type="hidden" name="txtsubtotal" id="txtsubtotal" value="0"/>
                    <input type="hidden" name="txtsubtotal2" id="txtsubtotal2" value="0"/>
                    <input type="hidden" name="iva" id="iva" value="<?php echo number_format($valor, 2, '.', ''); ?>">
                    <input type="hidden" name="txtIva" id="txtIva" value="0"/>
                    <input type="hidden" name="txtdescontado" id="txtdescontado" value="0"/>
                    <input type="hidden" name="txtDescuento" id="txtDescuento" value="0"/>
                    <input type="hidden" name="txtTotal" id="txtTotal" value="0"/>
                    <input type="hidden" name="txtImporte" id="txtImporte" value="0"/>
                    <input type="hidden" name="txtAgregado" id="txtAgregado" value="0"/>
...
<?php } ?>
        ...
        <div class="tab-content" id="pills-tabContent">
           ...
           <div class="tab-pane fade p-3 show active" id="pills-productos" role="tabpanel" aria-labelledby="pills-home-tab">
            ...
            <div class="table-responsive">
                ...
                for($i=0;$i<sizeof($pfavoritos);$i++){?>      
                    ...
                    <tbody>
                      <tr class="table2">
                        <td class="alert-link"><span style="cursor:pointer;" OnClick="DoAction('<?php echo $pfavoritos[$i]['idproducto']; ?>','<?php echo $pfavoritos[$i]['codproducto']; ?>','<?php echo $pfavoritos[$i]['producto']; ?>','<?php echo $pfavoritos[$i]['codcategoria']; ?>','<?php echo $pfavoritos[$i]['nomcategoria']; ?>','<?php echo number_format($pfavoritos[$i]['preciocompra'], 0, '.', ''); ?>','<?php echo number_format($pfavoritos[$i]['precioventa'], 0, '.', ''); ?>','<?php echo number_format($pfavoritos[$i]['descproducto'], 0, '.', ''); ?>','<?php echo $ivaproducto = ( $pfavoritos[$i]['ivaproducto'] == 'SI' ? number_format($valor, 0, '.', '') : "(E)"); ?>','<?php echo number_format($pfavoritos[$i]['existencia'], 2, '.', ''); ?>','<?php echo $precioconiva = ( $pfavoritos[$i]['ivaproducto'] == 'SI' ? number_format($pfavoritos[$i]['precioventa'], 0, '.', '') : "0"); ?>','<?php echo "1"; ?>','<?php echo ", "; ?>','<?php echo ", "; ?>','<?php echo $pfavoritos[$i]['preparado']; ?>');"><?php echo $pfavoritos[$i]['producto']; ?></span></td>
                    </tr>
                <?php } } ?>
                    </tbody>
                </table></div></div>
          ...
          <div class="table-responsive">
                ...
                for($i=0;$i<sizeof($cfavoritos);$i++){?>      
                    ...
                    <tbody>
                      <tr class="table2">
                        <td class="alert-link"><span style="cursor:pointer;" OnClick="DoAction('<?php echo $cfavoritos[$i]['idcombo']; ?>','<?php echo $cfavoritos[$i]['codcombo']; ?>','<?php echo $cfavoritos[$i]['nomcombo']; ?>','<?php echo "********"; ?>','<?php echo "********"; ?>','<?php echo number_format($cfavoritos[$i]['preciocompra'], 0, '.', ''); ?>','<?php echo number_format($cfavoritos[$i]['precioventa'], 0, '.', ''); ?>','<?php echo number_format($cfavoritos[$i]['desccombo'], 0, '.', ''); ?>','<?php echo $ivaproducto = ( $cfavoritos[$i]['ivacombo'] == 'SI' ? number_format($valor, 0, '.', '') : "(E)"); ?>','<?php echo number_format($cfavoritos[$i]['existencia'], 2, '.', ''); ?>','<?php echo $precioconiva = ( $cfavoritos[$i]['ivacombo'] == 'SI' ? number_format($cfavoritos[$i]['precioventa'], 0, '.', '') : "0"); ?>','<?php echo "2"; ?>','<?php echo ", "; ?>','<?php echo ", "; ?>','<?php echo $cfavoritos[$i]['preparado']; ?>');"><?php echo $cfavoritos[$i]['nomcombo']; ?></span></td>
                    </tr>
                <?php } } ?>
                    </tbody>
                </table></div></div>
          ...
          <div class="table-responsive">
                ...
                for($i=0;$i<sizeof($efavoritos);$i++){?>      
                    ...
                    <tbody>
                      <tr class="table2">
                        <td class="alert-link"><span style="cursor:pointer;" OnClick="DoAction('<?php echo $efavoritos[$i]['idingrediente']; ?>','<?php echo $efavoritos[$i]['codingrediente']; ?>','<?php echo $efavoritos[$i]['nomingrediente']; ?>','<?php echo $efavoritos[$i]['codmedida']; ?>','<?php echo $efavoritos[$i]['nommedida']; ?>','<?php echo number_format($efavoritos[$i]['preciocompra'], 0, '.', ''); ?>','<?php echo number_format($efavoritos[$i]['precioventa'], 0, '.', ''); ?>','<?php echo number_format($efavoritos[$i]['descingrediente'], 0, '.', ''); ?>','<?php echo $ivaproducto = ( $efavoritos[$i]['ivaingrediente'] == 'SI' ? number_format($valor, 0, '.', '') : "(E)"); ?>','<?php echo number_format($efavoritos[$i]['cantingrediente'], 2, '.', ''); ?>','<?php echo $precioconiva = ( $efavoritos[$i]['ivaingrediente'] == 'SI' ? number_format($efavoritos[$i]['precioventa'], 0, '.', '') : "0"); ?>','<?php echo "3"; ?>','<?php echo ", "; ?>','<?php echo ", "; ?>','<?php echo $efavoritos[$i]['preparado']; ?>');"><?php echo $efavoritos[$i]['nomingrediente']; ?></span></td>
                    </tr>
                <?php } } ?>
                    </tbody>
                </table></div></div>
    ...
    <script type="text/javascript">
    setTimeout(function() {
        $('#notificaciones').load("notificaciones?CargaNotificacion=si&tipo="+'<?php echo encrypt('3'); ?>');
    }, 5000);
