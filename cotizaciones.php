        ...
        <form class="form form-material" name="procesacotizacion" id="procesacotizacion" action="#">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group has-feedback2">
                        ...
                        <textarea class="form-control" type="text" name="direccion_delivery" id="direccion_delivery" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Dirección Delivery" rows="1" required="" aria-required="true"></textarea>
            ...
            <div class="row">
                <div class="col-md-4">
                   ...
                   <h4 class="mb-0 font-medium"><label id="TextImporte" name="TextImporte">0</label></h4>
                </div>

                <div class="col-md-4">
                   <h4 class="mb-0 font-light">Total Recibido</h4>
                   <h4 class="mb-0 font-medium"><label id="TextPagado" name="TextPagado">0</label></h4>
                </div>

                <div class="col-md-4">
                   <h4 class="mb-0 font-light">Total Cambio</h4>
                   <h4 class="mb-0 font-medium"><label id="TextCambio" name="TextCambio">0</label></h4>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                   ...
                   <h4 class="mb-0 font-medium"><label id="TextCredito" name="TextCredito">0</label></h4>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6"> 
                    <div class="form-group has-feedback"> 
                        ...
                        <select style="color:#000;font-weight:bold;" name="repartidores" id="repartidores" class="form-control" required="" aria-required="true">
                ...
                <div class="col-md-6"> 
                    <div class="form-group has-feedback"> 
                        ...
                        <input style="color:#000;font-weight:bold;" class="form-control" type="text" name="montodelivery" id="montodelivery" onKeyUp="DevolucionCotizacion();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" autocomplete="off" placeholder="Ingrese Costo Delivery" value="0" disabled="" required="" aria-required="true"> 
            ...
            <div class="row">
              <div class="col-md-12"> 
                <div class="form-group has-feedback"> 
                  ...
                  <input type="hidden" name="montodevuelto" id="montodevuelto" value="0.00">
                  <input style="color:#000;font-weight:bold;" class="form-control" type="text" name="montopagado" id="montopagado" onKeyUp="DevolucionCotizacion();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" autocomplete="off" placeholder="Monto de Pago Nº 1" value="" required="" aria-required="true"> 
                  <i class="fa fa-dollar form-control-feedback"></i>
                </div> 
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-dark" type="button" class="close" data-dismiss="modal" aria-hidden="true" onclick="document.getElementById('procesacotizacion').reset();"><span class="fa fa-trash-o"></span> Cancelar</button>
            </div>
        </form>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="cotizacionesxsucursal" id="cotizacionesxsucursal">
            ...
            <div class="text-right">
                <button type="button" id="BotonBusqueda" onClick="BuscaCotizacionesxSucursal()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
            </div>
