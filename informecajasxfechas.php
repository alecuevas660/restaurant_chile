...
<div class="row">
    ...
    <form class="form form-material" method="post" action="#" name="informescajasxfechas" id="informescajasxfechas">
    ...
    <div class="row">
        ...
        <button type="button" id="BotonBusqueda" onClick="BuscarInformesCajasxFechas()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestrainformescajasxfechas"></div>
