...
$accesos = ['administradorS', 'secretaria', 'cajero', 'mesero'];
...
?>
    ...
    <div id="productList2">
        ...
        <?php if ($_SESSION["acceso"]=="administradorS" || $_SESSION["acceso"]=="cajero" || $_SESSION["acceso"]=="mesero") { ?>
            ...
            <div class="users-list-name codMesa" title="<?php echo $mesa[$ii]['nommesa']; ?> <?php echo $var = ($mesa[$ii]['statusmesa'] == '0' || $mesa[$ii]['statusmesa'] == '2' ? '(DISPONIBLE)' : '(OCUPADA)'); ?>" style="cursor:pointer;" onclick="VerificaMesa('<?php echo encrypt($mesa[$ii]['codmesa']); ?>')">
                ...
                <center class="text-dark alert-link font-12"><?php echo $mesa[$ii]['total_deudas']=="" ? $mesa[$ii]['simbolo']."0" : $mesa[$ii]['simbolo'].number_format($mesa[$ii]['total_deudas'], 0, '.', '.'); ?><br><span class="text-danger alert-link" title="ATENDIDA POR: <?php echo $mesa[$ii]['nombres']; ?>"><?php echo getSubString($mesa[$ii]['nombres'],14); ?></span></center>
            </div>

        <?php } elseif ($_SESSION["acceso"]=="cajero_usuario") { ?>     
            ...
            <div class="users-list-name codMesa" title="<?php echo $mesa[$ii]['nommesa']; ?> <?php echo $var = ($mesa[$ii]['statusmesa'] == '0' || $mesa[$ii]['statusmesa'] == '2' ? '(DISPONIBLE)' : '(PENDIENTE DE COBRO)'); ?>" style="cursor:pointer;" <?php if ($mesa[$ii]['statusmesa'] == '0') { ?> onclick="MesaDisponible();" <?php } else { ?> onclick="ProcesarMesa('<?php echo encrypt($mesa[$ii]['codmesa']); ?>','<?php echo encrypt($mesa[$ii]['codsucursal']); ?>')" <?php } ?>>
                ...
                <center class="text-dark alert-link font-12"><?php echo $mesa[$ii]['puestos']; ?> PERSONAS</center>
                <center class="text-dark alert-link font-12"><?php echo $mesa[$ii]['total_deudas']=="" ? $mesa[$ii]['simbolo']."0" : $mesa[$ii]['simbolo'].number_format($mesa[$ii]['total_deudas'], 0, '.', '.'); ?></center>
            </div>
...
?>
    ...
    <div id="productList2">
        ...
        '<?php echo number_format($producto[$ii]['preciocompra'], 0, '.', ''); ?>',
        '<?php echo number_format($producto[$ii]['precioventa'], 0, '.', ''); ?>',
        '<?php echo number_format($producto[$ii]['descproducto'], 0, '.', ''); ?>',
        '<?php echo $ivaproducto = ( $producto[$ii]['ivaproducto'] == 'SI' ? number_format($valor, 0, '.', '') : "(E)"); ?>',
        '<?php echo number_format($producto[$ii]['existencia'], 2, '.', ''); ?>',
        '<?php echo $precioconiva = ( $producto[$ii]['ivaproducto'] == 'SI' ? number_format($producto[$ii]['precioventa'], 0, '.', '') : "0.00"); ?>',
        '<?php echo "1"; ?>',
        '<?php echo ", "; ?>',        
        '<?php echo ", "; ?>',
        ...
        <div id="<?php echo $producto[$ii]['codproducto']; ?>">
            <div class="darkblue-panel pn" title="<?php echo $producto[$ii]['producto'].' | ('.$producto[$ii]['nomcategoria'].')';?>">
                <div class="darkblue-header">
                   <div class="text-white font-12"><?php echo getSubString($producto[$ii]['producto'],18);?></div>
                </div>
                <?php
                if (file_exists("./fotos/productos/".$producto[$ii]["codsucursal"]."/".$producto[$ii]["codproducto"].".jpg")){
                echo "<img src='fotos/productos/".$producto[$ii]["codsucursal"]."/".$producto[$ii]['codproducto'].".jpg?".time()."' class='rounded-circle' style='width:130px;height:100px;'>";
                } else if (file_exists("./fotos/productos/".$producto[$ii]["codsucursal"]."/".$producto[$ii]["codproducto"].".jpeg")){
                echo "<img src='fotos/productos/".$producto[$ii]["codsucursal"]."/".$producto[$ii]['codproducto'].".jpeg?".time()."' class='rounded-circle' style='width:130px;height:100px;'>";
                } else if (file_exists("./fotos/productos/".$producto[$ii]["codsucursal"]."/".$producto[$ii]["codproducto"].".png")){
                echo "<img src='fotos/productos/".$producto[$ii]["codsucursal"]."/".$producto[$ii]['codproducto'].".png?".time()."' class='rounded-circle' style='width:130px;height:100px;'>";
                } else {
                ...
                <abbr title="<?php echo $producto[$ii]['montocambio'] == '' ? "" : $producto[$ii]['simbolo2'].number_format($producto[$ii]['precioventa']/$producto[$ii]['montocambio'], 2, '.', ','); ?>"><h5 style="font-size: 11.5px;" class="text-warning pull-right font-12"><?php echo $simbolo.number_format($producto[$ii]['precioventa'], 0, '.', '.');?></h5></abbr>
                </div>
            </div>
        </div>
...
<h3 class="card-subtitle m-0 text-dark"><i class='font-20 fa fa-archive'></i> Monitor de Combos</h3><hr>
    ...
    <div id="productList2">
        ...
        '<?php echo "0"; ?>',
        '<?php echo "0"; ?>',
        '<?php echo number_format($combo[$ii]['preciocompra'], 0, '.', ''); ?>',
        '<?php echo number_format($combo[$ii]['precioventa'], 0, '.', ''); ?>',
        '<?php echo number_format($combo[$ii]['desccombo'], 0, '.', ''); ?>',
        '<?php echo $ivacombo = ( $combo[$ii]['ivacombo'] == 'SI' ? number_format($valor, 0, '.', '') : "(E)"); ?>',
        '<?php echo number_format($combo[$ii]['existencia'], 2, '.', ''); ?>',
        '<?php echo $precioconiva = ( $combo[$ii]['ivacombo'] == 'SI' ? number_format($combo[$ii]['precioventa'], 0, '.', '') : "0.00"); ?>',
        '<?php echo "2"; ?>',
        '<?php echo ", "; ?>',       
        '<?php echo ", "; ?>',
        ...
        <div id="<?php echo $combo[$ii]['codcombo']; ?>">
            <div class="darkblue-panel pn" title="<?php echo $combo[$ii]['nomcombo'].'';?>">
                <div class="darkblue-header">
                   <div class="text-white font-12"><?php echo getSubString($combo[$ii]['nomcombo'],18);?></div>
                </div>
                <?php
                if (file_exists("./fotos/combos/".$combo[$ii]["codsucursal"]."/".$combo[$ii]["codcombo"].".jpg")){
                echo "<img src='fotos/combos/".$combo[$ii]["codsucursal"]."/".$combo[$ii]["codcombo"].".jpg?".time()."' class='rounded-circle' style='width:130px;height:100px;'>";
                } else if (file_exists("./fotos/combos/".$combo[$ii]["codsucursal"]."/".$combo[$ii]["codcombo"].".jpeg")){
                echo "<img src='fotos/combos/".$combo[$ii]["codsucursal"]."/".$combo[$ii]["codcombo"].".jpeg?".time()."' class='rounded-circle' style='width:130px;height:100px;'>";
                } else if (file_exists("./fotos/combos/".$combo[$ii]["codcombo"].".png")){
                echo "<img src='fotos/combos/".$combo[$ii]["codsucursal"]."/".$combo[$ii]["codcombo"].".png?".time()."' class='rounded-circle' style='width:130px;height:100px;'>";
                } else {
                echo "<img src='fotos/producto.png' class='rounded-circle' style='width:130px;height:100px;'>";  
                } ?>
                ...
                <abbr title="<?php echo $combo[$ii]['montocambio'] == '' ? "" : $combo[$ii]['simbolo2'].number_format($combo[$ii]['precioventa']/$combo[$ii]['montocambio'], 2, '.', ','); ?>"><h5 style="font-size: 11.5px;" class="text-warning pull-right font-12"><?php echo $simbolo.number_format($combo[$ii]['precioventa'], 0, '.', '.');?></h5></abbr>
                </div>
            </div>
        </div>
...
?>
    ...
    <div id="productList2">
        ...
        '<?php echo number_format($ingrediente[$ii]['preciocompra'], 0, '.', ''); ?>',
        '<?php echo number_format($ingrediente[$ii]['precioventa'], 0, '.', ''); ?>',
        '<?php echo number_format($ingrediente[$ii]['descingrediente'], 0, '.', ''); ?>',
        '<?php echo $ivaingrediente = ( $ingrediente[$ii]['ivaingrediente'] == 'SI' ? number_format($valor, 0, '.', '') : "(E)"); ?>',
        '<?php echo number_format($ingrediente[$ii]['cantingrediente'], 2, '.', ''); ?>',
        '<?php echo $precioconiva = ( $ingrediente[$ii]['ivaingrediente'] == 'SI' ? number_format($ingrediente[$ii]['precioventa'], 0, '.', '') : "0.00"); ?>',
        '<?php echo "3"; ?>',
        '<?php echo ", "; ?>',       
        '<?php echo ", "; ?>',
        ...
        <div id="<?php echo $ingrediente[$ii]['codingrediente']; ?>">
            <div class="darkblue-panel pn" title="<?php echo $ingrediente[$ii]['nomingrediente'].' | ('.$ingrediente[$ii]['nommedida'].')';?>">
                <div class="darkblue-header">
                   <div class="text-white font-12"><?php echo getSubString($ingrediente[$ii]['nomingrediente'],18);?></div>
                </div>
                <img src='fotos/producto.png' class='rounded-circle' style='width:130px;height:100px;'>
                <input type="hidden" id="proname" name="proname" value="<?php echo $ingrediente[$ii]['codingrediente'].", ".$ingrediente[$ii]['nomingrediente']; ?>">
                ...
                <abbr title="<?php echo $ingrediente[$ii]['montocambio'] == '' ? "" : $ingrediente[$ii]['simbolo2'].number_format($ingrediente[$ii]['precioventa']/$ingrediente[$ii]['montocambio'], 2, '.', ','); ?>"><h5 style="font-size: 11.5px;" class="text-warning pull-right font-12"><?php echo $simbolo.number_format($ingrediente[$ii]['precioventa'], 0, '.', '.');?></h5></abbr>
                </div>
            </div>
        </div>
...
?> 
        ...
        for($i=0;$i<sizeof($efavoritos);$i++){?>      
            ...
            <tbody>
              <tr class="table2">
                <td class="alert-link"><span style="cursor:pointer;" OnClick="DoAction('<?php echo $efavoritos[$i]['idingrediente']; ?>','<?php echo $efavoritos[$i]['codingrediente']; ?>','<?php echo $efavoritos[$i]['nomingrediente']; ?>','<?php echo $efavoritos[$i]['codmedida']; ?>','<?php echo $efavoritos[$i]['nommedida']; ?>','<?php echo number_format($efavoritos[$i]['preciocompra'], 0, '.', ''); ?>','<?php echo number_format($efavoritos[$i]['precioventa'], 0, '.', ''); ?>','<?php echo number_format($efavoritos[$i]['descingrediente'], 2, '.', ''); ?>','<?php echo $ivaproducto = ( $efavoritos[$i]['ivaingrediente'] == 'SI' ? number_format($valor, 0, '.', '') : "(E)"); ?>','<?php echo number_format($efavoritos[$i]['cantingrediente'], 2, '.', ''); ?>','<?php echo $precioconiva = ( $efavoritos[$i]['ivaingrediente'] == 'SI' ? number_format($efavoritos[$i]['precioventa'], 0, '.', '') : "0.00"); ?>','<?php echo "3"; ?>','<?php echo ", "; ?>','<?php echo ", "; ?>','<?php echo $efavoritos[$i]['preparado']; ?>');"><?php echo $efavoritos[$i]['nomingrediente']; ?></span></td>
            </tr>
        <?php } } ?>
            </tbody>
        </table>
