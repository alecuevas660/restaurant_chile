...
<body onLoad="muestraReloj()" class="fix-header">
   ...
   <!-- ============================================================== -->
    ...
    <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Ganancias por Fechas</h5>
                    </div>
...
<div class="row">
    ...
    <form class="form form-material" method="post" action="#" name="gananciasventasxfechas" id="gananciasventasxfechas">
    ...
    <div class="row">
        ...
        <button type="button" id="BotonBusqueda" onClick="BuscarGananciasVentasxFechas()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestragananciasventasxfechas"></div>
