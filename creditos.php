...
<body onLoad="muestraReloj(); getTime(); <?php if($_SESSION['acceso'] != "administradorG"){ ?>CargarCreditos()<?php } ?>" class="fix-header">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        ...
                        <input type="hidden" name="formulario" id="formulario" value="creditos"/>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-warning">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Búsqueda de Créditos</h4>
            </div>
        ...
        <form class="form form-material" method="post" action="#" name="creditosxsucursal" id="creditosxsucursal">
            ...
            <div class="text-right">
                <button type="button" id="BotonBusqueda" onClick="BuscaCreditosxSucursal()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
            </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="form form-material" method="post" action="#" name="busquedacreditos" id="busquedacreditos">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group has-feedback">
                            ...
                            <div class="n-chk">
                                <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                                  <input type="radio" class="new-control-input" name="tipobusqueda" id="tipobusqueda3" value="3" onClick="VerificaTipoBusqueda()">
                ...
                <div class="text-right">
                    <button type="button" id="BotonBusqueda" onClick="BuscarCreditos()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                </div>
...
<?php } ?>
    ...
    function CargarCreditos(){
        ...
        $('#muestra_detalles').append('<center><i class="fa fa-spin fa-spinner"></i> Por favor espere, cargando registros ......</center>').fadeIn("slow");
        setTimeout(function() {
        $('#muestra_detalles').load("consultas?CargaCreditos=si&tipobusqueda=1&search_criterio=&desde=&hasta=");
        }, 200);
    }    
    </script>
    <?php } ?>
