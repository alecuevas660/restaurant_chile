...
<div id="myModalUser" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        ...
                        <i class="fa fa-bars form-control-feedback"></i>
                    <select style="color:#000;font-weight:bold;" name="nivel" id="nivel" class="form-control" onChange="CargarSucursalesUsuarios(this.form.nivel.value);" required="" aria-required="true">
                            <option value=""> -- SELECCIONE -- </option>
            ...
            <div class="row"> 
                ...
                <div class="col-md-4"> 
                    <div class="form-group has-feedback"> 
                       ...
                       <input type="text" class="form-control" name="comision" id="comision" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Comisión por Ventas" value="0" required="" aria-required="true">
                    ...
                    <div class="form-group has-feedback">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="form-group has-feedback"> 
                                ...
                                </div><small><p>Para Subir su Foto debe tener en cuenta:<br> * La Imagen debe ser extension.jpg<br> * La imagen no debe ser mayor de 2 MB</p></small>
                            </div>
                        </div>
                    </div> 
                </div>
        ...
        <div class="modal-footer">
            ...
            document.getElementById('codsucursal').value = '<?php echo $_SESSION['acceso'] == "administradorG" ? "0" : encrypt($_SESSION['codsucursal']); ?>',
            document.getElementById('imagen').value = '',
            document.getElementById('muestrasucursales').innerHTML = ''
