        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    ...
                    <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Detalles por Cajas</h5>
                    </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-warning">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Detalles por Cajas</h4>
            </div>
            
    <form class="form form-material" method="post" action="#" name="detallesventasxcajas" id="detallesventasxcajas">
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                <label class="control-label">Tipo de Pago: <span class="symbol required"></span></label><br>
                <div class="form-check form-check-inline">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="1" name="tipopago" value="<?php echo encrypt("1"); ?>" checked="checked">
                ...
                <div class="form-check form-check-inline">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="2" name="tipopago" value="<?php echo encrypt("2"); ?>">
                        <label class="custom-control-label" for="2">CONTADO</label>
                    </div>
                </div><br>

                <div class="form-check form-check-inline">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="3" name="tipopago" value="<?php echo encrypt("3"); ?>">
                        <label class="custom-control-label" for="3">CRÉDITO</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="form-group has-feedback">
                ...
                <i class="fa fa-calendar form-control-feedback"></i>
                    ...
                    <div class="text-right">
                        <button type="button" id="BotonBusqueda" onClick="BuscarDetallesVentasxCajas()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestradetallesventasxcajas"></div>
