    ...
    <div class="col-lg-3">
        <div class="card">
            ...
            <div class="form-body">
                      ...
                      <div class="text-center"><div class="fileinput fileinput-new" data-provides="fileinput">
                          <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 220px; height: 230px;">
                            ...
                            if (isset($reg[0]['codproducto'])) {
                                ...
                                echo "<img src='fotos/productos/".$reg[0]["codsucursal"]."/".$reg[0]['codproducto'].".jpg?".date('h:i:s')."' class='rounded-circle' width='200' height='200'>";
                                } else if (file_exists("fotos/productos/".$reg[0]["codsucursal"]."/".$reg[0]["codproducto"].".jpeg")){
                                echo "<img src='fotos/productos/".$reg[0]["codsucursal"]."/".$reg[0]["codproducto"].".jpeg?".date('h:i:s')."' class='rounded-circle' width='200' height='200'>";
                                } else if (file_exists("fotos/productos/".$reg[0]["codsucursal"]."/".$reg[0]["codproducto"].".png")){
                                echo "<img src='fotos/productos/".$reg[0]["codsucursal"]."/".$reg[0]["codproducto"].".png?".date('h:i:s')."' class='rounded-circle' width='200' height='200'>";
                                } else {
                                echo "<img src='fotos/img.png' class='rounded-circle' width='200' height='200'>"; 
                                } } else {
                                echo "<img src='fotos/img.png' class='rounded-circle' width='200' height='200'>"; 
                            }
                            ?>
                ...
                </div><!--<small>Para subir la Imagen debe tener en cuenta:<br> * La Imagen debe ser extension.jpg<br> * La Imagen no debe ser mayor de 1 MB</small>-->
            ...
            <div class="row">
                <div class="col-md-12"> 
                    <div class="form-group has-feedback"> 
                        ...
                        <select style="color:#000;font-weight:bold;" name="codsucursal" id="codsucursal" onChange="CargaCategoriasxSucursal(this.form.codsucursal.value); CargaProveedoresxSucursal(this.form.codsucursal.value);" class="form-control" required= "" aria-required="true">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        ...
                        <i class="fa fa-bars form-control-feedback"></i>
                        <?php if ($_SESSION['acceso'] == "administradorG" && !isset($reg[0]['codcategoria'])) { ?>
                        ...
                        <?php } elseif (isset($reg[0]['codcategoria'])) { ?>
                        <select style="color:#000;font-weight:bold;" name="codcategoria" id="codcategoria" class='form-control' required="" aria-required="true">
                        <option value=""> -- SELECCIONE -- </option>
                        <?php
                        $categoria = new Login();
                        ...
                        <option value="<?php echo encrypt($categoria[$i]['codcategoria']); ?>"<?php if (!(strcmp($reg[0]['codcategoria'], htmlentities($categoria[$i]['codcategoria'])))) { echo "selected=\"selected\"";} ?>><?php echo $categoria[$i]['nomcategoria'] ?></option>        
                        <?php } } ?>
                        </select>  
                        <?php } else { ?>
                        <select style="color:#000;font-weight:bold;" name="codcategoria" id="codcategoria" class='form-control' required="" aria-required="true">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control" name="preciocompra" id="preciocompra" onKeyUp="this.value=this.value.toUpperCase();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" placeholder="Ingrese Precio de Compra" autocomplete="off" <?php if (isset($reg[0]['preciocompra'])) { ?> value="<?php echo number_format($reg[0]['preciocompra'], 0, '.', ''); ?>" <?php } ?> required="" aria-required="true"/>  
                ...
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control" name="precioventa" id="precioventa" onKeyUp="this.value=this.value.toUpperCase();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" placeholder="Ingrese Precio de Venta" autocomplete="off" <?php if (isset($reg[0]['precioventa'])) { ?> value="<?php echo number_format($reg[0]['precioventa'], 0, '.', ''); ?>" <?php } ?>  required="" aria-required="true"/>  
                        <i class="fa fa-dollar form-control-feedback"></i>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control" name="existencia" id="existencia" onKeyUp="this.value=this.value.toUpperCase();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" placeholder="Ingrese Existencia de Producto" autocomplete="off" <?php if (isset($reg[0]['existencia'])) { ?> value="<?php echo number_format($reg[0]['existencia'], 2, '.', ''); ?>" <?php } ?> required="" aria-required="true"/>  
                        <i class="fa fa-bolt form-control-feedback"></i>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        <label class="control-label">Stock Minimo: <span class="symbol required"></span></label>
                         <input type="text" class="form-control" name="stockminimo" id="stockminimo" onKeyUp="this.value=this.value.toUpperCase();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" placeholder="Ingrese Stock Minimo" autocomplete="off" <?php if (isset($reg[0]['stockminimo'])) { ?> value="<?php echo number_format($reg[0]['stockminimo'], 2, '.', ''); ?>" <?php } else { ?> value="0.00" <?php } ?> required="" aria-required="true"/>  
                        <i class="fa fa-bolt form-control-feedback"></i> 
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control" name="descproducto" id="descproducto" onKeyUp="this.value=this.value.toUpperCase();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" placeholder="Ingrese Descuento de Producto" autocomplete="off" <?php if (isset($reg[0]['descproducto'])) { ?> value="<?php echo number_format($reg[0]['descproducto'], 0, '.', ''); ?>" <?php } else { ?> value="0.00" <?php } ?> required="" aria-required="true"/>  
                        <i class="fa fa-dollar form-control-feedback"></i>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group has-feedback">
                    ...
                    <input style="color:#000;font-weight:bold;" type="text" class="form-control agregaingrediente" name="search_ingrediente_sucursal" id="search_ingrediente_sucursal" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Realice la Búsqueda de Ingrediente" autocomplete="off"/>
            ...
            <div class="col-md-3">  
                <div class="form-group has-feedback"> 
                    ...
                    <input style="color:#000;font-weight:bold;" type="text" class="form-control agregaingrediente" name="cantidad" id="cantidad" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Cantidad de Porción" title="Ingrese Cantidad de Porción" autocomplete="off" value="0.5"/>  
                    <i class="fa fa-pencil form-control-feedback"></i>                                           
                </div>
            </div>
            ...
            <div class="col-md-3">  
                <div class="form-group has-feedback"> 
                    ...
                    <input style="color:#000;font-weight:bold;" type="text" class="form-control" name="medida" id="medida" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Unidad de Medida" autocomplete="off" readonly=""/>  
                    <i class="fa fa-pencil form-control-feedback"></i>                                           
                </div>
            </div>  
        </div>
...
?>
    ...
    <span class="input-group-btn input-group-prepend"><button class="btn btn-classic bootstrap-touchspin-down input-button" style="cursor:pointer;border-radius:5px 0px 0px 5px;background-color:#ffb22b;" type="button" onClick="PresionarDetalleIngrediente('a',<?php echo $count; ?>)"><span class='fa fa-minus'></span></button></span>
    <input type="text" class="bold" name="cantidad[]" id="cantidad_<?php echo $count; ?>" style="width:60px;height:40px;font-size:14px;background:#e7f8fc;font-weight:bold;" onfocus="this.style.background=('#e7f8fc')" onKeyPress="EvaluateText('%f', this);" onBlur="this.style.background=('#e7f8fc'); this.value = NumberFormat(this.value, '2', '.', '');" onKeyUp="this.value=this.value.toUpperCase(); ProcesarCalculoIngrediente(<?php echo $count; ?>);" autocomplete="off" placeholder="Cantidad" value="<?php echo number_format($busq[$i]["cantracion"], 2, '.', ''); ?>" title="Ingrese Cantidad">
    <input type="hidden" name="cantidadbd[]" id="cantidadbd_<?php echo $count; ?>" value="<?php echo number_format($busq[$i]["cantracion"], 2, '.', ''); ?>">
    <span class="input-group-btn input-group-append"><button class="btn btn-classic bootstrap-touchspin-up" type="button" style="cursor:pointer;border-radius:0px 5px 5px 0px;background-color:#ffb22b;" onClick="PresionarDetalleIngrediente('b',<?php echo $count; ?>)"><span class='fa fa-plus'></span></button></span>
    </div>
    </td>
    <td>
    <input type="hidden" name="codagrega[]" id="codagrega_<?php echo $count; ?>" value="<?php echo $busq[$i]["codagrega"]; ?>">
    <input type="hidden" name="idingrediente[]" id="idingrediente_<?php echo $count; ?>" value="<?php echo $busq[$i]["idingrediente"]; ?>">
    <input type="hidden" name="codingrediente[]" id="codingrediente_<?php echo $count; ?>" value="<?php echo $busq[$i]["codingrediente"]; ?>">
    <input type="hidden" name="cantingrediente[]" id="cantingrediente_<?php echo $count; ?>" value="<?php echo $busq[$i]["cantingrediente"]; ?>">
    ...
    <td><label id="txtmontocompra_<?php echo $count; ?>"><?php echo number_format($busq[$i]["cantracion"]*$busq[$i]["preciocompra"], 0, '.', ','); ?></label></td>
    <td><label id="txtmontoventa_<?php echo $count; ?>"><?php echo number_format($busq[$i]["cantracion"]*$busq[$i]["precioventa"], 0, '.', ','); ?></label></td>
                </tr><?php } } ?>
              </tbody>
        </table></div><br>
