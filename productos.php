...
<!--############################## MODAL PARA CARGA MASIVA DE PRODUCTO ######################################-->
<!-- sample modal content -->
...
<div id="myModalStock" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form class="form form-material" method="post" action="#" name="savestockproducto" id="savestockproducto">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control" name="codproducto" id="codproducto" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Código de Producto" autocomplete="off" disabled="" required="" aria-required="true"/> 
            ...
            <div class="col-md-6">
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control" name="producto" id="producto" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Nombre de Producto" autocomplete="off" disabled="" required="" aria-required="true"/> 
                    ...
                    <div class="row">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-left" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(164px, 35px, 0px);">
                                ...
                                <a class="dropdown-item" href="reportepdf?tipo=<?php echo encrypt("PRODUCTOSMINIMO") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="bottom" title="Exportar Pdf"><span class="fa fa-file-pdf-o text-dark"></span> Stock Minimo</a>

                                <a class="dropdown-item" href="reportepdf?tipo=<?php echo encrypt("PRODUCTOSMAXIMO") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="bottom" title="Exportar Pdf"><span class="fa fa-file-pdf-o text-dark"></span> Stock Máximo</a>
