    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="row">
            ...
            <div class="modal-footer">
                <button type="submit" name="btn-proveedor" id="btn-proveedor" class="btn btn-warning"><span class="fa fa-save"></span> Guardar</button>
...
<?php } ?>
    ...
    <div class="row"> 
        <div class="col-md-3"> 
            <div class="form-group has-feedback"> 
                ...
                <input type="hidden" name="formulario" id="formulario" value="forcompra">
                <input class="form-control" type="text" name="codfactura" id="codfactura" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="N° Compra" <?php if (isset($reg[0]['codfactura'])) { ?> value="<?php echo $reg[0]['codfactura']; ?>" <?php } else { ?> required="" aria-required="true" <?php } ?>>
    ...
    <div class="row"> 
        ...
        <div class="col-md-3"> 
            <div class="form-group has-feedback"> 
               <label class="control-label">Fecha Vence Crédito: <span class="symbol required"></span></label> 
               <input type="text" class="form-control" name="fechavencecredito" id="fechavencecredito" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Fecha Vence Crédito" disabled="" required="" aria-required="true">
               <i class="fa fa-calendar form-control-feedback"></i>  
            </div> 
        </div>  
...
?>
    ...
    <input type="hidden" name="precioventa[]" id="precioventa" value="<?php echo number_format($detalle[$i]["precioventac"], 0, '.', ''); ?>">
    ...
    <td><strong><input type="hidden" name="preciocompra[]" id="preciocompra_<?php echo $count; ?>" value="<?php echo number_format($detalle[$i]['preciocomprac'], 0, '.', ','); ?>">
    <input type="hidden" name="precioconiva[]" id="precioconiva_<?php echo $count; ?>" value="<?php echo $detalle[$i]['ivaproductoc'] == '0' ? "0" : number_format($detalle[$i]["preciocomprac"], 0, '.', ''); ?>"><?php echo number_format($detalle[$i]['preciocomprac'], 0, '.', ','); ?></strong></td>
    ...
    <td><input type="hidden" name="ivaproducto[]" id="ivaproducto_<?php echo $count; ?>" value="<?php echo $detalle[$i]["ivaproductoc"]; ?>"><label><?php echo $detalle[$i]['ivaproductoc'] != '0' ? number_format($detalle[$i]['ivaproductoc'], 0, '.', '')."%" : "(E)"; ?></label></td>

    <td><input type="hidden" class="subtotalivasi" name="subtotalivasi[]" id="subtotalivasi_<?php echo $count; ?>" value="<?php echo $detalle[$i]['ivaproductoc'] != '0' ? number_format($detalle[$i]['valorneto'], 0, '.', '') : "0"; ?>">

    <input type="hidden" class="subtotalivano" name="subtotalivano[]" id="subtotalivano_<?php echo $count; ?>" value="<?php echo $detalle[$i]['ivaproductoc'] == '0' ? number_format($detalle[$i]['valorneto'], 0, '.', '') : "0"; ?>">
    ...
    <input type="hidden" class="subtotaldiscriminado" name="subtotaldiscriminado[]" id="subtotaldiscriminado_<?php echo $count; ?>" value="<?php echo $detalle[$i]['ivaproductoc'] != '0' ? number_format($detalle[$i]['valorneto']-$detalle[$i]['subtotalimpuestos'], 0, '.', '') : "0"; ?>">

    <input type="hidden" class="valorneto" name="valorneto[]" id="valorneto_<?php echo $count; ?>" value="<?php echo number_format($detalle[$i]['valorneto'], 2, '.', ''); ?>" ><label id="txtvalorneto_<?php echo $count; ?>"><?php echo number_format($detalle[$i]['valorneto'], 0, '.', ','); ?></label></td>
...
<?php } else { ?>
        ...
        <div class="row">
            ...
            <div class="col-md-4"> 
                <div class="form-group has-feedback"> 
                   ...
                   <input style="color:#000;font-weight:bold;" type="text" class="form-control" name="search_compra" id="search_compra" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Realice la Búsqueda por Código o Descripción">
                   <i class="fa fa-search form-control-feedback"></i> 
                </div> 
            </div>
            ...
            <div class="col-md-2"> 
                <div class="form-group has-feedback"> 
                    ...
                    <input type="text" class="form-control" name="cantidad" id="cantidad" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Cantidad" autocomplete="off">
                    <i class="fa fa-bolt form-control-feedback"></i> 
                </div> 
            </div>
            ...
            <div class="col-md-2"> 
                <div class="form-group has-feedback"> 
                    ...
                    <input class="form-control" type="text" name="descfactura" id="descfactura" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Descuento en Compra" value="0">
            ...
            <div class="col-md-2"> 
                <div class="form-group has-feedback"> 
                    ...
                    <input class="form-control" type="text" name="descproducto" id="descproducto" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Descuento en Venta" value="0">
                    <i class="fa fa-dollar form-control-feedback"></i> 
                </div> 
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-2"> 
                <div class="form-group has-feedback"> 
                    ...
                    <input class="form-control calculoprecio" type="text" name="preciocompra" id="preciocompra" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Precio de Compra">
                    <input type="hidden" name="precioconiva" id="precioconiva" value="0">                        
                    <i class="fa fa-dollar form-control-feedback"></i> 
                </div> 
            </div>                                                                                                                             
            <div class="col-md-2"> 
                <div class="form-group has-feedback"> 
                    ...
                    <input class="form-control" type="text" name="precioventa" id="precioventa" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Precio de Venta" value="0">
                    <i class="fa fa-dollar form-control-feedback"></i> 
                </div> 
            </div> 
            ...
            <div class="col-md-2">
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control expira" name="fechaexpiracion" id="fechaexpiracion" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Fecha de Exp." autocomplete="off"/>  
                    <i class="fa fa-calendar form-control-feedback"></i>
                </div>
            </div>
        </div>  
    ...
    <td>
    <h5><label>Desc. Global <input class="number" type="text" name="descuento" id="descuento" onKeyPress="EvaluateText('%f', this);" style="border-radius:4px;height:30px;width:60px;" onBlur="this.value = NumberFormat(this.value, '0', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" value="0">%:</label></h5>    </td>
